...
const MoneyReceiveIcon: React.FC<TSVGIconProp> = ({
  size = 16,
  color = "#000000",
  ...props
}) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
      ...
      />
      <Path
        d="M17.6 9.60001C17.6 14.016 14.016 17.6 9.59998 17.6C5.18398 17.6 1.59998 14.016 1.59998 9.60001C1.59998 5.18401 5.18398 1.60001 9.59998 1.60001"
        stroke={color}
        stroke-width="1.27358"
        stroke-linecap="round"
        stroke-linejoin="round"
...
export default memo(MoneyReceiveIcon);
